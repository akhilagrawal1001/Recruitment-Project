...
By default the program is written by assuming that user will run program on google colab. User has to upload these data files in the 'Files' section in colab file, which are uploaded in '/content' directory by default.
